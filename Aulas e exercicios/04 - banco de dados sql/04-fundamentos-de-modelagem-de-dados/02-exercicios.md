...
| ID  | NUMERO_CONTA | NOME_TITULAR   | TIPO          | VALOR  |
|-----|-------------|---------------|---------------|--------|
...
**A partir dessa tabela, aplique o processo de normalização até a Terceira Forma Normal (3NF). O resultado final deve ser três entidades separadas: EXTRATO, TIPO_REGISTRO e CLIENTE.**
